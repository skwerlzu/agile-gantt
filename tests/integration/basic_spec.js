function expectIsMounted(url) {
  cy.viewport(1440, 900)
    ...
    .then(window => {
      expect(typeof window.AgileGantt).to.equal('object');
...
function expectTimeZoomChange(url) {
  cy.viewport(1440, 900)
    ...
    .visit(url, { timeout: 10000 })
    .then(window => {
      const timeZoomSelector = '.agile-gantt__header-options > label:nth-child(2) .vue-slider-dot';
...
function expectAddTask(url) {
  cy.viewport(1440, 900)
    ...
    .then(window => {
      ...
      cy.get(
        'div.agile-gantt__task-list-items > div:nth-child(2) > div:nth-child(2) > div > div.agile-gantt__task-list-expander-wrapper > svg'
      )
        .click()
        .wait(100)
        .then(() => {
    ...
    .then(window => {
      ...
      cy.get(
        ...
        .then(() => {
          ...
          // return task 7
          return cy.get(
            '.agile-gantt__task-list-items > div:nth-child(4) > div:nth-child(2) > div > div.agile-gantt__task-list-expander-wrapper > svg'
          );
        })
        .click()
        .wait(50)
        ...
        .then(() => {
          ...
          // return task 2
          return cy.get(
            '.agile-gantt__task-list-items > div:nth-child(2) > div:nth-child(2) > div > div.agile-gantt__task-list-expander-wrapper > svg'
          );
        })
        .click()
        .wait(50)
...
describe('Basic', () => {
  it('should mount agile-gantt - umd', () => {
    expectIsMounted(umd);
  });
  it('should mount agile-gantt - standalone', () => {
