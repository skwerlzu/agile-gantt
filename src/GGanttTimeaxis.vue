    ...
    >
      ...
      >
        <div class="g-timeaxis-day-div">
			<v-list-item three-line :dark="dark">
			  <v-list-item-content>
				<v-list-item-title class="text-center">{{ day ? dayFormatted(day, "dddd") : 'Loading' }}</v-list-item-title>
				<v-list-item-subtitle class="text-center">
				  {{ day ? dayFormatted(day, "MMMM Do") : 'Loading' }}
				</v-list-item-subtitle>
				<v-list-item-subtitle v-if="!toggleDateVisible" class="text-center">
