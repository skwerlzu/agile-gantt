...
<template>
  <div
    class="agile-gantt__task-list-header"
    :style="{
  ...
  >
    <div
      class="agile-gantt__task-list-header-column"
      :style="{
    ...
    >
      ...
      ></task-list-expander>
      <div
        class="agile-gantt__task-list-header-label"
      ...
      <div
        class="agile-gantt__task-list-header-resizer-wrapper"
        :style="{
      ...
      >
        <div
          class="agile-gantt__task-list-header-resizer"
          :style="{ ...root.style['task-list-header-resizer'], ...column.style['task-list-header-resizer'] }"
        >
          <div
            class="agile-gantt__task-list-header-resizer-dot"
