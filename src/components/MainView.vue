...
-->
<template>
  <div class="agile-gantt__main-view" :style="{ ...root.style['main-view'] }">
    <div
      class="agile-gantt__main-container-wrapper"
      :style="{ ...root.style['main-container-wrapper'], height: root.state.options.height + 'px' }"
    >
      <div
        class="agile-gantt__main-container"
        :style="{
      ...
      >
        ...
        >
          <div
            ref="taskList"
            class="agile-gantt__task-list-container"
            :style="{
          ...
          <div
            class="agile-gantt__main-view-container"
      ...
      <div
        class="agile-gantt__chart-scroll-container agile-gantt__chart-scroll-container--vertical"
        :style="{
      ...
      >
        <div
          class="agile-gantt__chart-scroll--vertical"
          :style="{ width: '1px', height: root.state.options.allVisibleTasksHeight + 'px' }"
        ></div>
      </div>
    </div>
    <div
      class="agile-gantt__chart-scroll-container agile-gantt__chart-scroll-container--horizontal"
      :style="{
        ...root.style['chart-scroll-container'],
    ...
    >
      <div
        class="agile-gantt__chart-scroll--horizontal"
