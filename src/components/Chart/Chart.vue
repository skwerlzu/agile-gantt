...
-->
<template>
  <div class="agile-gantt__chart" :style="{ ...root.style['chart'] }" ref="chart">
    <div
      class="agile-gantt__chart-calendar-container"
    ...
    <div
      class="agile-gantt__chart-graph-container"
    ...
    >
      ...
      >
        <div
          class="agile-gantt__chart-graph"
          ref="chartGraph"
          :style="{ ...root.style['chart-graph'], height: '100%' }"
        >
          <svg
            class="agile-gantt__chart-graph-svg"
          ...
          >
            ...
            <g
              class="agile-gantt__chart-row-wrapper"
