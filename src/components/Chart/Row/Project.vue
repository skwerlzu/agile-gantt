...
<template>
  <g
    class="agile-gantt__chart-row-bar-wrapper agile-gantt__chart-row-project-wrapper"
    :style="{
  ...
  >
    <foreignObject
      class="agile-gantt__chart-expander agile-gantt__chart-expander--project"
      :style="{
    ...
    <svg
      class="agile-gantt__chart-row-bar agile-gantt__chart-row-project"
    ...
    >
      ...
      <path
        class="agile-gantt__chart-row-bar-polygon agile-gantt__chart-row-project-polygon"
        :style="{
