...
<template>
  <svg
    class="agile-gantt__grid-lines-wrapper"
  ...
  >
    <g class="agile-gantt__grid-lines" :style="{ ...root.style['grid-lines'] }">
      <line
        class="agile-gantt__grid-line-horizontal"
      ...
      ></line>
      <line
        class="agile-gantt__grid-line-vertical"
