...
<template>
  <svg
    class="agile-gantt__chart-row-text-wrapper"
  ...
  >
    <foreignObject x="0" y="0" width="100%" :height="getHeight">
      <div
        ...
        class="agile-gantt__chart-row-text"
        :style="{ ...root.style['chart-row-text'] }"
      >
        <div
          class="agile-gantt__chart-row-text-content agile-gantt__chart-row-text-content--text"
          :style="{
        ...
        <div
          class="agile-gantt__chart-row-text-content agile-gantt__chart-row-text-content--html"
          :style="{
            ...root.style['chart-row-text-content'],
