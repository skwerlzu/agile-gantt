...
-->
<template>
  <div :class="'agile-gantt__calendar-row agile-gantt__calendar-row--' + which" :style="rowStyle">
    <div
      v-for="(item, itemIndex) in items"
      :key="item.key"
      :class="'agile-gantt__calendar-row-rect agile-gantt__calendar-row-rect--' + which"
      :style="rectStyle"
    >
      <div
        :class="'agile-gantt__calendar-row-rect-child agile-gantt__calendar-row-rect-child--' + which"
        v-for="(child, childIndex) in item.children"
        :key="child.key"
        :style="rectChildStyle[itemIndex][childIndex]"
      >
        <div
          :class="'agile-gantt__calendar-row-text agile-gantt__calendar-row-text--' + which"
